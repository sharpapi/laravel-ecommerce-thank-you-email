...
All notable changes to `laravel-ecommerce-thank-you-email` will be documented in this file.

## v1.1.0 - 2026-09-24

- Ship a Laravel Boost skill (`resources/boost/skills/sharpapi-ecommerce-thank-you-email`) so AI coding agents use the async submit + `fetchResults()` flow, queued jobs and failed-job checks correctly.
...
- Initial release
- Support for generating personalized thank you emails with customizable parameters
